    ...
    return (
      <View style={styles.container}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('List of Products')}>
          <Text style={styles.touchtext}> MANAGE PRODUCTS </Text>
        </TouchableOpacity>
  ...
  var productitems = [
    {
      ...
      cost: '1300',
      image:
        'https://i.pinimg.com/originals/f3/18/5f/f3185f78fcb64b2319aeb48ecd5a8bc1.jpg',
    },
    {
      itemname: 'BLADE',
      cost: '3500',
  ...
  var members = [
    {
      ...
      height: '175 cm',
      image:
        'https://i.pinimg.com/originals/c9/93/65/c99365f329b7c82cf52beeb837fc52a5.jpg',
    },
    {
      name: 'MIKASA ACKERMAN',
      height: '165cm',
